...
const App = () => {
    return (
        <div className="page_container">
            ...
            <Switch>
            <Route exact path="/">{<Main_Home/>}</Route>
                ...
                <Route path="/viewcertificates">{<ViewCertificates/>}</Route>
                ...
                <Route path = "/admin-notification">{<ANotification/>}</Route>
                <Route path="/adminsupport">{<Adminsupport/>}</Route>
                <Route path="/adminchangepassword">{<Adminchangepassword/>}</Route>
                <Route path="/view-teacherprofile">{<ViewTeacherP/>}</Route>
                <Route path = "/admin-retirement-history">{<Aretirementhistory/>}</Route>
                <Route path = "/admin-retire-teacher">{<Aretirement/>}</Route>
                <Route path = "/transfer-teacher">{<ATranferteacher/>}</Route>
                <Route path = "/admin-transfer-history">{<ATransferHistory/>}</Route>
                <Route path = "/promote-teacher">{<Apromote/>}</Route>
                <Route path = "/admin-promotion-history">{<Apromotionhistory/>}</Route>
                ...
                <Route path = "/admin-view-notification">{<AviewNotification/>}</Route>
                <Route path = "/admin-punishment-history">{<APunishmentHistory/>}</Route>
                ...
                <Route path = "/admin-award-history">{<AAwardhistory/>}</Route>
                <Route path = "/school-view-profile">{<ASchoolPview/>}</Route>
                <Route path = "/downloads-gos">{<Gos/>}</Route>
                <Route path = "/downloads-acts-and-rules">{<ActsAndRules/>}</Route>
